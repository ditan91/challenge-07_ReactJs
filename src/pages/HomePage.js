...
function HomePage() {
  ...
  return (
    <div>
      ...
      {/* Section 2 */}
      <div className="place-items-center m-0 mt-[150px] m-[80px]">
        <h1 className="font-sans text-black font-bold text-2xl mb-5 mr-[170px]">
          Why Us?
        </h1>
        ...
        <div className="flex">
          <div className="border rounded pt-8 pb-8 pl-8 mr-8">
            ...
            <h2 className="font-sans text-black font-bold text-base">
              Mobil Lengkap
            </h2>
      ...
      <div className="text-center bg-[#0D28A6] m-[70px] p-8 rounded-lg">
        <h1 className="font-sans text-white font-bold text-2xl mt-8">
          Sewa Mobil di Bandung
        </h1>
        <p className="font-sans text-white text-sm mt-5 mb-8">
      ...
      <div className="grid grid-cols-2 m-[70px] mt-[150px]">
        <div className="">
          ...
          <p className="font-sans text-black text-sm mt-5 mb-8">
        ...
        <div className="">
          <div className="relative w-[700px] ml-[-100px] mb-8">
            <select className="w-full p-5 text-black-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600">
              <option className="font-sans text-black text-sm mt-5 mb-8">
